  ...
  return (
    <View style={HomeStyles.container}>
      <ScrollView style={HomeStyles.scrollView}>
        ...
        <View
          style={ViewStyles({flexDirection: 'row', alignItems: 'center'}).box}>
          <View
            style={
              ViewStyles({height: 120, alignItems: 'center'}).innerProfile
            }>
            <Avatar.Image
        ...
        <View style={ViewStyles({justifyContent: 'flex-start'}).box}>
          <Text style={{fontFamily: '', fontSize: 20, fontWeight: 'bold'}}>
            여행 도우미
          </Text>
          <Text style={{fontFamily: '', fontSize: 16}}>
            여행에 도움이 되는정보를 찾아보세요
